  ...
  return (
    <AdminLayout>
      <div className="min-h-screen bg-gray-50">
        <div className="p-8">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Detection Dashboard</h1>
            <p className="text-gray-600">Monitor and analyze content moderation performance of the Murai extension.</p>
          </div>
